...
/**
  split a string with seperator sep, return a vector contained with splitted
  result
 */
...
/**
 split a string with seperator sep, return a vector contained with splitted
 result sep support regular express
 */
inline std::vector<std::string> splitEx(const std::string& val,
                                        const std::string& sep) {
  std::smatch m;
  std::vector<std::string> ret;
  std::regex e(sep);
